...
\section {Methodology}
 We will begin our study by studying what are FP propertises and then try to figure out and propose a set of metrics that would check on FP-like properties.\par
